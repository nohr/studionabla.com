...
function section(y) {
  ...
  /SECTION BACK GROUND IMAGES/;
  const s1 = "url(img/slide/slide-01.jpg)";
  const s2 = "url(img/slide/slide-06.jpg)";
  const s3 = "url(img/slide/slide-05.jpg)";
  const s4 = "url(img/slide/slide-14.jpg)";
  if (x.style.display == "none" || x.style.display == "null") {
    ...
    head.style.backgroundImage = s1;
  } else if (y == 2) {
    x.style.display = "none";
    head.style.border = "none";
    head.style.backgroundImage = s2;
  } else if (y == 3) {
    x.style.display = "none";
    head.style.border = "none";
    head.style.backgroundImage = s3;
  } else if (y == 4) {
    x.style.display = "none";
    head.style.border = "none";
    head.style.backgroundImage = s4;
  }
}
