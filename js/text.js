if (window.matchMedia('only screen and (min-width: 1200px)').matches) {
    var text0 = "Studio Nabla is a multi-disciplinary art and design studio founded by Aite Eboigbe in 2017. <br>To view a work, scroll through the sidebar to the left, select a work, and then scroll vertically. <br> <br> <span> If you would like to inquire about my services, feel free to contact me at <a href='mailto:info@studionabla.com'>info@studionabla.com</a>.";
